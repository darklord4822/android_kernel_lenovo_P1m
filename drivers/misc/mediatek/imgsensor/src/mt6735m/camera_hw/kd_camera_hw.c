...
#define VOL_1000 1000000
	...
	if (On) {
		...
		} else if ((currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI551_MIPI_RAW, currSensorName))) || (currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI551AVC_MIPI_RAW, currSensorName))))
		{
		   ...
		   if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN]) {
			...
			//disable Main sensor (suka neuzheli pofixil)
